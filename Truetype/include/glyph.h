...
namespace Truetype
{
	...
	int calculateWindingNumber(int numPoints, uint16* finalFlags, int16* xCoords, int16* yCoords, int numContours, uint16* contourEnds, int x, int y, const Glyph& glyph)
	{
